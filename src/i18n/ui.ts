...
export const ui = {
  en: {
    ...
    'newsletter.footer.copy': 'By subscribing to my Saint-Malo newsletters, you will receive a <strong>free</strong> extract from my ebook on Saint-Malo! You can unsubscribe at any time, with one click.',
    ...
    'newsletter.header.subtitle': 'Are you interested in Brittany?<br />Or do you want to find out more about Quebec?<br />Maybe both? The choice is yours!',
    ...
    'post.comments.form.errors.callback': 'Oups, sometthing went wrong. Please, contact me directly at:',
    ...
    'post.comments.form.newsletter.ebook': 'and will receive a <strong>free sample</strong> of my e-book on Saint-Malo.',
    ...
    'post.comments.form.success': 'Thank you for your comment! Your comment has been sent and will be displayed after validation.',
  ...
  fr: {
    ...
    'ebook.banner.buy.subtitle': "<strong>180+ pages</strong> au format PDF sur Saint-Malo et la Côte d'Émeraude. Compatible avec votre tablette.",
    ...
    'ebook.banner.sample.subtitle': 'Vous recevrez également ma newsletter sur Saint-Malo et la Bretagne.',
    'ebook.banner.sample.success': 'Super ! Vérifiez votre boite mail, vous devriez recevoir le ebook sous peu !',
    'ebook.banner.sample.title': 'Téléchargez gratuitement un extrait de mon ebook sur Saint-Malo et ses environs',
    'ebook.thankyou.text': "Votre soutien est non seulement une source d'encouragement, mais il contribue également directement à la réalisation de mon projet d'écriture sur Saint-Malo et la Bretagne. <strong>Surveillez votre boite email, l’ebook devrait arriver sous peu !</strong> En cas de soucis, n'hésitez pas à me contacter sur <a href=\"mailto:sarah@carnetsvanille.com\">sarah@carnetsvanille.com</a>.",
    'ebook.thankyou.title': 'Merci pour votre achat',
    'form.error.fields': 'Oups, au moins un des champs obligatoires est incorrect !',
    'form.error.generic': "Oups, il y a eu un problème. Veuillez me contacter directement à l'adresse suivante : ",
    'form.input.email': 'Email',
    ...
    'newsletter.card.title': 'Vous souhaitez recevoir des informations sur Saint-Malo ou sur le Québec ?',
    'newsletter.footer.copy': 'En vous abonnant à mes carnets d’actualités sur Saint-Malo, vous recevrez <strong>gratuitement</strong> un extrait de mon ebook sur Saint-Malo ! Vous pouvez vous désabonner à tout moment, en un clic.',
    ...
    'newsletter.form.success': 'Merci :) Surveillez votre boîte de réception pour ne rien manquer !',
    'newsletter.header.subtitle': 'C’est la Bretagne qui vous intéresse ?<br />Ou au contraire, vous voulez en savoir plus sur le Québec ?<br />Les 2 peut-être ? À vous de choisir !',
    ...
    'post.comments.form.email': 'Email',
    'post.comments.form.errors.callback': "Oups, il y a eu un problème. Veuillez me contacter directement à l'adresse suivante : ",
    ...
    'post.comments.form.newsletter.ebook': 'et vais recevoir un <strong>ebook gratuit</strong> sur Saint-Malo et ses environs.',
    ...
    'post.comments.form.success': 'Merci ! Votre commentaire a bien été envoyé et sera affiché après validation.',
    ...
    'product.playbook.digitalProduct': 'Carnet de jeu numérique',
